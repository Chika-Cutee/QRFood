...
class OrderController extends Controller
{
    public function createOrder(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'email' => 'nullable|string', // <--- TAMBAHAN 1: Terima input email
        ]);
        ...
        try {
            ...
            // 4. JIKA PEMBAYARAN MIDTRANS -> Minta Snap Token
            if ($validatedData['metode_pembayaran'] == 'MIDTRANS') {
                ...
                $params = [
                    ...
                    'customer_details' => [
                        ...
                        'email'      => $request->email, // <--- TAMBAHAN 2: Masukkan email ke sini
                    ],
                    'expiry' => [
                        'start_time' => date("Y-m-d H:i:s O"), // Waktu mulai (sekarang)
                        'unit' => 'minutes',                   // Satuan waktu
                        'duration' => 15                       // Durasi
                    ],
                ];
